    ...
    var o,
      ...
      w = function () {
        ...
        return (
          ...
          a ||
            ((a = s = h.createElement("body")), (a.style.background = "none")),
      ...
      E = function (t) {
        var a = "clientWidth",
          ...
          f = new Date().getTime();
        if (t && o && f - o < g)
          return e.clearTimeout(l), void (l = e.setTimeout(E, g));
        for (var y in ((o = f), u))
          if (u.hasOwnProperty(y)) {
            ...
            T && (T = parseFloat(T) * (T.indexOf(C) > -1 ? m || w() : 1)),
              ...
              (S.hasquery && ((z && b) || !(z || r >= T) || !(b || r <= $))) ||
                (s[S.media] || (s[S.media] = []), s[S.media].push(c[S.rules]));
          }
        for (var R in p)
          p.hasOwnProperty(R) &&
            p[R] &&
          ...
          if (s.hasOwnProperty(O)) {
            ...
            (M.type = "text/css"),
              ...
              M.styleSheet
                ...
                : M.appendChild(h.createTextNode(k)),
              p.push(M);
          }
      },
      S = function (e, t, n) {
        var r = e
            .replace(a.regex.comments, "")
            .replace(a.regex.keyframes, "")
            .match(a.regex.media),
          s = (r && r.length) || 0;
        ...
        for (var m = 0; m < s; m++) {
          ...
          l
            ? ((h = n), c.push(o(e)))
            : ((h = r[m].match(a.regex.findStyles) && RegExp.$1),
          ...
          for (var g = 0; g < f; g++)
            (d = p[g]),
              i(d) ||
                u.push({
                  media:
                    (d.split("(")[0].match(a.regex.only) && RegExp.$2) || "all",
                  rules: c.length - 1,
                  hasquery: d.indexOf("(") > -1,
                  minw:
                    d.match(a.regex.minw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                  maxw:
                    d.match(a.regex.maxw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                });
        }
        E();
        ...
        for (var t = 0; t < v.length; t++) {
          ...
          r &&
            ...
            (a.styleSheet && a.styleSheet.rawCssText
              ? (S(a.styleSheet.rawCssText, r, s), (f[r] = !0))
              : ((/^([a-zA-Z:]*\/\/)/.test(r) || y) &&
                  r.replace(RegExp.$1, "").split("/")[0] !== e.location.host) ||
                ("//" === r.substring(0, 2) && (r = e.location.protocol + r),
                n.push({ href: r, media: s })));
        }
        T();
      };
    $(),
