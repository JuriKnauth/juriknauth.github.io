(function (e, t) {
  ...
  function u(e) {
    var t = {};
    return (
      Se.each(e.match(Pe) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function j(e, t, n) {
    n
      ...
      : void 0 === Be.get(e, t) && Se.event.add(e, t, S);
  }
  function D(e, t) {
    return (
      (o(e, "table") &&
  ...
  function H(e, t) {
    var n, r, i, o, a, s, u;
    if (1 === t.nodeType) {
      if (Be.hasData(e) && ((o = Be.get(e)), (u = o.events), u))
        for (i in (Be.remove(t, "handle events"), u))
          for (n = 0, r = u[i].length; n < r; n++) Se.event.add(t, i, u[i][n]);
      _e.hasData(e) &&
        ((a = _e.access(e)), (s = Se.extend({}, a)), _e.set(t, s));
    }
  }
  function O(e, t) {
  ...
  function P(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = xe(h);
    if (g || (p > 1 && "string" == typeof h && !me.checkClone && ct.test(h)))
    ...
    if (
      ...
      for (s = Se.map(w(o, "script"), q), u = s.length; f < p; f++)
        (l = o),
          f !== d &&
            ((l = Se.clone(l, !0, !0)), u && Se.merge(s, w(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, Se.map(s, L), f = 0; f < u; f++)
          (l = s[f]),
            ot.test(l.type || "") &&
  ...
  function B(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += Se.css(e, n + Ge[a], !0, i)),
        r
          ? ("content" === n && (u -= Se.css(e, "padding" + Ge[a], !0, i)),
            "margin" !== n &&
              (u -= Se.css(e, "border" + Ge[a] + "Width", !0, i)))
          : ((u += Se.css(e, "padding" + Ge[a], !0, i)),
            "padding" !== n
              ? (u += Se.css(e, "border" + Ge[a] + "Width", !0, i))
              : (s += Se.css(e, "border" + Ge[a] + "Width", !0, i)));
    return (
      !r &&
        o >= 0 &&
        (u +=
  ...
  function J(e, t, n) {
    ...
    for (Q(c, l.opts.specialEasing); o < a; o++)
      if (((r = J.prefilters[o].call(l, e, c, l.opts)), r))
        return (
          xe(r.stop) &&
      ...
      function (e) {
        ...
        return r != H && 9 === r.nodeType && r.documentElement
          ? ((H = r),
            ...
            (T.cssSupportsSelector = i(function () {
              return (
            ...
            T.cssSupportsSelector || R.push(":has"),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!T.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e == H || (e.ownerDocument == $ && W($, e))
                        ? -1
                        : t == H || (t.ownerDocument == $ && W($, t))
                        ? 1
                        : D
                        ? te(D, e) - te(D, t)
                        : 0
  ...
  (Se.find = Ee),
    (Se.expr = Ee.selectors),
    (Se.expr[":"] = Se.expr.pseudos),
    (Se.uniqueSort = Se.unique = Ee.uniqueSort),
    (Se.text = Ee.getText),
    (Se.isXMLDoc = Ee.isXML),
    (Se.contains = Ee.contains),
    (Se.escapeSelector = Ee.escape);
  ...
  (Se.filter = function (e, t, n) {
    ...
    Se.fn.extend({
      ...
      is: function (e) {
        return !!a(
          this,
          "string" == typeof e && Ne.test(e) ? Se(e) : e || [],
          !1
        ).length;
      },
    });
      ...
      if (((n = n || De), "string" == typeof e)) {
        ...
        if (r[1]) {
          if (
            ...
            je.test(r[1]) && Se.isPlainObject(t))
          )
      ...
      function (e, t) {
        Se.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Oe[e] || Se.uniqueSort(i), He.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
                ...
                return function () {
                      ...
                      : function () {
                          try {
                            ...
                            Se.Deferred.exceptionHook &&
                              Se.Deferred.exceptionHook(e, p.stackTrace),
                              t + 1 >= a &&
                                (r !== c && ((s = void 0), (u = [e])),
                                n.rejectWith(s, u));
                          }
                  ...
                  t
                    ...
                    : (Se.Deferred.getStackHook &&
                        (p.stackTrace = Se.Deferred.getStackHook()),
                      e.setTimeout(p));
                };
              }
              var a = 0;
    ...
    Se.extend({
      ...
      ready: function (e) {
        (!0 === e ? --Se.readyWait : Se.isReady) ||
          ((Se.isReady = !0),
          (!0 !== e && --Se.readyWait > 0) || Me.resolveWith(we, [Se]));
      },
    }),
    ...
    Se.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = _e.get(o)), 1 === o.nodeType && !Be.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = Be.access(e, t, Se.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
  ...
  Ye.getRootNode &&
    (Qe = function (e) {
      return (
        Se.contains(e.ownerDocument, e) || e.getRootNode(Je) === e.ownerDocument
      );
    });
  var Ke = function (e, t) {
      return (
        ...
        "none" === e.style.display ||
          ("" === e.style.display && Qe(e) && "none" === Se.css(e, "display"))
      );
    },
    Ze = {};
  Se.fn.extend({
  ...
  (et = we.createDocumentFragment()),
    (tt = et.appendChild(we.createElement("div"))),
    (nt = we.createElement("input")),
    nt.setAttribute("type", "radio"),
    nt.setAttribute("checked", "checked"),
    nt.setAttribute("name", "t"),
    tt.appendChild(nt),
    (me.checkClone = tt.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (tt.innerHTML = "<textarea>x</textarea>"),
    (me.noCloneChecked = !!tt.cloneNode(!0).lastChild.defaultValue),
    (tt.innerHTML = "<option></option>"),
    (me.option = !!tt.lastChild);
  var at = {
    thead: [1, "<table>", "</table>"],
  ...
  (Se.event = {
      ...
      if ($e(e))
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            i && Se.find.matchesSelector(Ye, i),
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        Se.isEmptyObject(u) && Be.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            rt.test(t.type) && t.click && o(t, "input") && j(t, "click", S), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            rt.test(t.type) && t.click && o(t, "input") && j(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
    ...
    Se.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (Se.cleanData(w(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  (t = this[n] || {}),
                    1 === t.nodeType &&
                      (Se.cleanData(w(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return P(
          ...
          function (t) {
            ...
            Se.inArray(this, e) < 0 &&
              (Se.cleanData(w(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  Se.extend({
    ...
    Se.each(["height", "width"], function (e, t) {
      Se.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !Tt.test(Se.css(e, "display")) ||
    ...
    (Se.cssHooks.marginLeft = I(me.reliableMarginLeft, function (e, t) {
      if (t)
        return (
      ...
      _default: {
        ...
        set: function (e) {
          Se.fx.step[e.prop]
            ? Se.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!Se.cssHooks[e.prop] && null == e.elem.style[F(e.prop)])
            ? (e.elem[e.prop] = e.now)
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && Se.isXMLDoc(e)) ||
                (i =
                  ...
                  (Se.expr.match.bool.test(t) ? jt : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : qt.test(e.nodeName) || (Lt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
          ...
          : ((t = ee(e)),
            t.length
              ? this.each(function () {
                  if (
                    ((r = Z(this)),
                    (n = 1 === this.nodeType && " " + K(r) + " "),
                    n)
                  ) {
                    for (o = 0; o < t.length; o++)
                      (i = t[o]),
                        n.indexOf(" " + i + " ") < 0 && (n += i + " ");
                    (a = K(n)), r !== a && this.setAttribute("class", a);
                  }
                })
              : this);
      },
              ...
              if (s)
                ...
                (void 0 !== e && "boolean" !== a) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      r || !1 === e ? "" : Be.get(this, "__className__") || ""
                    ));
            }));
      },
      hasClass: function (e) {
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              t.isPropagationStopped() && p.addEventListener(h, Pt),
              r[h](),
              t.isPropagationStopped() && p.removeEventListener(h, Pt),
  ...
  (me.cors = !!tn && "withCredentials" in tn),
    (me.ajax = tn = !!tn),
    Se.ajaxTransport(function (t) {
      var n, r;
      if (me.cors || (tn && !t.crossDomain))
        return {
          send: function (i, o) {
            var a,
              s = t.xhr();
  ...
  Se.ajaxSetup({
    ...
    (me.createHTMLDocument =
      ((nn = we.implementation.createHTMLDocument("").body),
      (nn.innerHTML = "<form></form><form></form>"),
    ...
    Se.each(["top", "left"], function (e, t) {
      Se.cssHooks[t] = I(me.pixelPosition, function (e, n) {
        if (n)
          return (n = M(e, t)), pt.test(n) ? Se(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (Se.noConflict = function (t) {
      return (
        e.$ === Se && (e.$ = un), t && e.jQuery === Se && (e.jQuery = sn), Se
      );
    }),
